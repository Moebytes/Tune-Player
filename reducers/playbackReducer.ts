...
const playbackSlice = createSlice({
    ...
    reducers: {
        ...
        setEffects: (state, action) => {state.effects = action.payload},
...
const {
    ...
    setEffects, setPlayHover, setVolumeHover, setSampleRate, setReverbMix,
...
export const usePlaybackSelector = () => {
    ...
    return {
        ...
        effects: selector((state) => state.playback.effects),
...
export const usePlaybackActions = () => {
    ...
    return {
        ...
        setEffects: (state: {type: string, node: Tone.ToneAudioNode}[]) => dispatch(setEffects(state)),
